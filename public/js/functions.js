function convertHex(e, t) {
    return e = e.replace("#", ""),
        r = parseInt(e.substring(0, 2), 16), g = parseInt(e.substring(2, 4), 16), b = parseInt(e.substring(4, 6), 16), result = "rgba(" + r + ", " + g + ", " + b + ", " + t + ")", result
}! function(n) {
    "use strict";
            ...
            function() {
                ...
                n("#form-cta-subscribe-1").on("submit", function(e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        u(!1, t), h()
                    } else e.preventDefault(), a = n("#cs1Name").val(), i = n("#cs1Email").val(), n.ajax({
                        type: "POST",
                        url: "./php/cs1-process.php",
                        data: "cs1Name=" + a + "&cs1Email=" + i,
                        success: function(e) {
                            var t, a;
                            "success" == e ? (t = n(".cs-notifications").data("success-msg"), a = t || "Thank you for your submission :)", n("#form-cta-subscribe-1")[0].reset(), u(!0, '<i class="cs-success-icon fa fa-check"></i>' + a), n(".cs-notifications-content").addClass("sent"), n(".cs-notifications").css("opacity", 0), n(".cs-notifications").slideDown(300).animate({
                                opacity: 1
                            }, 300).delay(5e3).slideUp(400)) : (h(), u(!1, e))
                        }
                    });
                    var a, i
                })
